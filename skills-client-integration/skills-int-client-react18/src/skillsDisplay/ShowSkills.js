...
const ShowSkill = () => {
    ...
    const [options, setOptions] = React.useState({ isSummaryOnly: isSummaryOnly, internalBackButton: internalBackButton, autoScrollStrategy: 'top-offset', scrollTopOffset: 134 });
              ...
              <div className="d-flex align-items-center">
                  ...
                  <Button variant={isSummaryOnly ? 'primary' : 'outline-primary'}
                          onClick={() => { setIsSummaryOnly(!isSummaryOnly);
                              setOptions({isSummaryOnly:!isSummaryOnly,internalBackButton:internalBackButton,autoScrollStrategy: 'top-offset', scrollTopOffset: 134}) }}>Summary Only</Button>

                  <Button variant={internalBackButton ? 'primary' : 'outline-primary'}
                          onClick={() => { setInternalBackButton(!internalBackButton);
                              setOptions({isSummaryOnly:isSummaryOnly,internalBackButton:!internalBackButton,autoScrollStrategy: 'top-offset', scrollTopOffset: 134}) }}>Internal Back Button</Button>
